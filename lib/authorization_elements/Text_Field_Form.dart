...
class Text_Field_Form extends StatefulWidget {
  const Text_Field_Form({super.key,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: widget.isPassword ? IconButton(
            icon: Icon(_ishidden ? Icons.visibility_off : Icons.visibility),iconSize: 15,
            onPressed: () {
              setState(() {
                _ishidden = !_ishidden;
              });
        ...
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(20)),
        label: Text(
          widget.labelText, style: TextStyle(color: widget.labelColor),),
      ),
      validator: (value) {
        if (value == null || value == "") {
